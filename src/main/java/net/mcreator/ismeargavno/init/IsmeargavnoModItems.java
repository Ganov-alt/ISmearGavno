...
import net.mcreator.ismeargavno.item.ProperGeezersMealItem;
import net.mcreator.ismeargavno.item.PotatoWaterItem;
import net.mcreator.ismeargavno.item.PorcelainShardItem;
import net.mcreator.ismeargavno.item.PlateItem;
...
import net.mcreator.ismeargavno.item.GreenTeaItem;
import net.mcreator.ismeargavno.item.GreenTeaBagItem;
...
import net.mcreator.ismeargavno.item.EmptyTeaBagItem;
import net.mcreator.ismeargavno.item.DustItem;
import net.mcreator.ismeargavno.item.DownvoteItem;
import net.mcreator.ismeargavno.item.DirtyPlateItem;
...
import net.mcreator.ismeargavno.item.BlackTeaItem;
import net.mcreator.ismeargavno.item.BlackTeaBagItem;
